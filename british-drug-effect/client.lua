...
RegisterNetEvent('kypo-drug-effect:onGear')
AddEventHandler('kypo-drug-effect:onGear', function()
...
RegisterNetEvent('kypo-drug-effect:onSpeed')
AddEventHandler('kypo-drug-effect:onSpeed', function()
...
RegisterNetEvent('kypo-drug-effect:onHerion')
AddEventHandler('kypo-drug-effect:onHerion', function()
...
RegisterNetEvent('kypo-drug-effect:onMdma')
AddEventHandler('kypo-drug-effect:onMdma', function()
